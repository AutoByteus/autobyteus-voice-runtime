...
test('generate-manifest emits release-backed URLs and checksums', async () => {
  ...
  assert.equal(
    ...
    'https://github.com/AutoByteus/autobyteus-voice-runtime/releases/download/v0.1.1/whisper-cli-darwin-arm64',
  )
  assert.match(manifest.assets[0].sha256, /^[a-f0-9]{64}$/)
  assert.equal(
    manifest.model.url,
    'https://github.com/AutoByteus/autobyteus-voice-runtime/releases/download/v0.1.1/ggml-tiny.en-q5_1.bin',
  )
