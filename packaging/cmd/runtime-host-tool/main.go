...
func build(args []string) {
	...
	write(*report, map[string]any{"schemaVersion": 2, "sha256": result.SHA256, "compressedSizeBytes": result.CompressedSizeBytes, "extractedSizeBytes": result.ExtractedSizeBytes, "entryCount": result.EntryCount})
}
